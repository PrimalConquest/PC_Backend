...
namespace SimulationEngine.Source.Data.Commands
{
    public class Move : IGameCommand
    {
        ...
        public bool CanExecute()
        {
            ...
            return SimulationSystem.CanUnitStep(
                _player.Board, _player.BoardUnits, _unitId, _direction, allowDisplace: true);
        }
        ...
        public void Execute()
        {
            ...
            SimulationSystem.ApplyUnitStep(_player, _unitId, _direction, EUnitEvent.Move);
